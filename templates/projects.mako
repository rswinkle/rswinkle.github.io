...
<p>
This is a list of some of my open source projects in roughly reverse chronological order.  Most of the newer ones just link to the Github repo since there's a description
in the README there
</p>
...
2009 programming competition.  The problems and test cases can be downloaded from their website
<a href="http://www.eas.asu.edu/~wcs/competition/">here</a>.  The cpp file is <a href="/projects/wateringlawn.cpp">here</a>.
</p>
...
<h4>Hide and Seek</h4>
<p>
This is a C++ program I wrote for CSE 100 honors project based on an idea I'd been wanting to try.  The program
...
The executable is <a href="/projects/Hide and Seek.zip">here</a>
</p>
